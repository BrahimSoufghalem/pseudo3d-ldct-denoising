...
Three independently switchable improvements (all OFF by default):
...
class LocalResidualBlock(nn.Module):
    """One residual block with optional HU-gate and frequency-boost."""
...
class LocalResidualNet(nn.Module):
    """Noise-subtraction network with optional HU-gate and freq-boost per block."""
