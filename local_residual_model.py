...
This is a diagnostic reproduction of the successful ldct-benchmark ResNet
inductive bias, not a novelty claim and not the final physics contribution.
It uses no pretrained weights, teacher, metadata, attention, dilation, pooling,
...
class LocalResidualNet(nn.Module):
    """Predict standardized noise and subtract it from standardized LDCT."""
